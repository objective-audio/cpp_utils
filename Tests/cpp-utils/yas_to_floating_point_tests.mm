//
//  yas_to_floating_point_tests.mm
//

#import <XCTest/XCTest.h>
#import <cpp-utils/yas_to_floating_point.h>
#include <typeinfo>

using namespace yas;

@interface yas_to_floating_point_tests : XCTestCase

@end

@implementation yas_to_floating_point_tests
